...
const DialogBottomSheet = React.forwardRef(
  ({ className, children, hideCloseButton = false, ...props }, ref) => {
    ...
    childrenArray.forEach((child) => {
      if (child?.props?.className?.includes('dialog-fixed-footer')) {
        fixedFooter.push(child);
      } else {
        scrollableContent.push(child);
      }
    });
      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            ...
            "lg:max-w-2xl lg:max-h-[85vh] lg:rounded-2xl lg:border lg:data-[state=closed]:slide-out-to-top-[48%] lg:data-[state=open]:slide-in-from-top-[48%]",
