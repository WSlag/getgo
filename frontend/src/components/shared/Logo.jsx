      ...
      <div className="relative">
        ...
        >
          ...
          <g transform="translate(8, 10)">
            ...
            {/* Wheels */}
            <circle cx="6" cy="15" r="2" fill="url(#accentGradient)" />
            <circle cx="14" cy="15" r="2" fill="url(#accentGradient)" />
            ...
            {/* Window */}
            <rect x="17" y="8" width="2" height="2" rx="0.5" fill="url(#accentGradient)" opacity="0.8" />

            {/* Cargo Details */}
            <line x1="5" y1="7" x2="13" y2="7" stroke="url(#accentGradient)" strokeWidth="1" strokeLinecap="round" opacity="0.6" />
            <line x1="5" y1="9" x2="13" y2="9" stroke="url(#accentGradient)" strokeWidth="1" strokeLinecap="round" opacity="0.6" />
            <line x1="5" y1="11" x2="11" y2="11" stroke="url(#accentGradient)" strokeWidth="1" strokeLinecap="round" opacity="0.6" />
          </g>
        </svg>
      </div>
