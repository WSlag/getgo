...
/**
 * Deprecated: listing chat requests are retired.
 * Users start a conversation by placing a bid.
 */
exports.requestListingChat = functions.region('asia-southeast1').https.onCall(async (data, context) => {
  ...
  return {
    success: false,
    deprecated: true,
    message: 'Chat request was removed. Place a bid to start a conversation.',
  };
});
