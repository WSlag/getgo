import{_ as P,C as _,r as N,c as R,l as L,d as E,O as x,n as F,k as S,p as U,u as $,F as M}from"./firebase-core-Ca22-hY6.js";/**
 * @license
...
`);i=h.pop()||"";for(const p of h)p.trim()&&s(p.trim(),a);return u()}catch(l){const c=l instanceof d?l:y(0,null);a.error(c),r(c)}}},cancel(){return e.cancel()}})}const O="@firebase/functions",C="0.13.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const te="auth-internal",ne="app-check-internal",re="messaging-internal";function se(e){const t=(r,{instanceIdentifier:n})=>{const s=r.getProvider("app").getImmediate(),o=r.getProvider(te),a=r.getProvider(re),i=r.getProvider(ne);return new B(s,o,a,i,n)};P(new _(k,t,"PUBLIC").setMultipleInstances(!0)),N(O,C,e),N(O,C,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ae(e=F(),t=w){const n=L(E(e),k).getImmediate({identifier:t}),s=x("functions");return s&&ie(n,...s),n}function ie(e,t,r){X(E(e),t,r)}function ce(e,t,r){return Y(E(e),t)}se();export{ae as g,ce as h};
